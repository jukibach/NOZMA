...
public class ExerciseRow {
    ...
    public void setExerciseTypesString(String exerciseTypesString) {
        ...
        this.exerciseTypes = Arrays
                .stream(exerciseTypesString.split(","))
                .map(String::trim)
                .toList();
    }
    ...
    public void setEquipmentsString(String equipmentsString) {
        ...
        this.equipments = Arrays
                .stream(equipmentsString.split(","))
                .map(String::trim)
                .toList();
    }
    ...
    public void setMovementPatternsString(String movementPatternsString) {
        ...
        this.movementPatterns = Arrays
                .stream(movementPatternsString.split(","))
                .map(String::trim)
                .toList();
    }
    ...
    public void setMuscleGroupString(String muscleGroupString) {
        ...
        this.muscleGroup = Arrays
                .stream(muscleGroupString.split(","))
                .map(String::trim)
                .toList();
    }
}
